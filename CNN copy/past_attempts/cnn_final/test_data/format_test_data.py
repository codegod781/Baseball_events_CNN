...
def append_to_total_training_data(file_to_append):
    ...
    #subrows_df = zero_out_high_activity_intervals(subrows_df) 
    
    subrows_df.to_csv("total_test_data.csv", mode='w', index=False, header=1)
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python format_test_data.py <filename>")
        sys.exit(1)
